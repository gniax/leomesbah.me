...
Personal portfolio site for Léo Mesbah.

This repo is intentionally simple: a static front-end with a small amount of client-side JS for navigation, project views and theme switching.
...
Open `index.html` directly in a browser, or serve the folder with a basic static server.

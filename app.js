...
const projects = {
  ...
  vinted: {
    ...
    sortYear: 2026,
    sortMonth: 2,
    railNote: "extension + Telegram bot, autofill, republishing",
    period: "recent",
    kind: "Browser tooling & automation",
    title: "Revinted",
    summary:
      "Toolkit to re-publish your own Vinted listings faster: a Firefox/Chrome extension that auto-fills the new-listing form, and a Telegram bot built on Playwright that republishes items on demand.",
    tech: ["JavaScript", "Node.js", "Playwright", "Telegram Bot API"],
    meta: ["Extension", "Telegram bot", "Automation", "Playwright"],
    points: [
      "Browser extension that saves a listing from its edit page and re-injects every field — photos included — on the create page.",
      "Node.js Telegram bot that drives Vinted through Playwright with multi-account support, image hash variation and optional LLM rewrites of titles and descriptions.",
      "Designed as two independent tools sharing one repo, so each can be used standalone.",
    ],
